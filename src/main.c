...
** Last update Fri May 26 15:47:06 2017 Sahel Lucas--Saoudi
*/
...
{
  t_needs	*needs;
  char          *name[5] = {"Martin", "Charlotte", "Hugo", "Sahel", NULL};
  char          *path[5] = {"ressource/sentences", "ressources/music/", "ressources/select", "ressource\
s/player", NULL};
